export const RESPONSES = {
  ...
  REMINDER_THRESHOLD_MET: (params: { responded: number; total: number; prompt: string }) =>
    `You're the last one! | ${params.responded}/ ${params.total}👪. Respond to see everyone's answers.\n\n Prompt: "${params.prompt}"`,
  REMINDER_THRESHOLD_UNMET: (params: { responded: number; total: number; prompt: string }) =>
    `Your fam is waiting for you! | ${params.responded}/ ${params.total}👪 have answered. Results will be sent in 1 hour. \n\n Prompt: "${params.prompt}"`,
